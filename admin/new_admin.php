            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0  bg-gradient ">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2  min-vh-100">
                    ...
                    <li class="nav-item w-100">
                        ...
                        <li class="nav-item w-100">
                            <a href="new_admin.php" class="nav-link px-0 align-middle acitve">
...
if(empty($username)){
  ...
  $user_count1=checkitem('username','users',$username);
  $cafe_count1=checkitem('hostuser','internetcafe',$username);
  $count1=$user_count1+$cafe_count1;
  if($count1>0){
...
if(empty($password)){
  $formerror4[]='password can\'t be empty';
}
if(empty($email)){
  $formerror5[]='email can\'t be empty';
}else{
  $user_count=checkitem('email','users',$email);
  $cafe_count=checkitem('email','internetcafe',$email);
  $count=$user_count+$cafe_count;
  if($count>0){
...
if(empty($formerror1)&&empty($formerror2)&&empty($formerror3)&&empty($formerror4)&&empty($formerror5)){
  ...
  VALUES(:zuser,:zpass,:zname,:zemail,:zage,now(),1)");     
  //execute query
  $stmt-> execute(array(
  'zuser'=> $username,
  'zpass'=> sha1($password),
  ...
  $success=array();
  $success[]= $name.' has been added as an admin successfully';
}
    ...
    <form action="" method="POST">
        <div class="d-flex flex-row align-items-center mb-4">
            ...
            <div class="form-outline flex-fill mb-0">
              <input type="text" id="form3Example1c"  placeholder="fullname" name="fullname" class="form-control" />
        ...
        <div class="d-flex flex-row align-items-center mb-4">
            ...
            <div class="form-outline flex-fill mb-0">
              <input type="text" id="form3Example1c" placeholder="username" name="username" class="form-control" />
...
<?php }?>
          ...
          <div class="d-flex flex-row align-items-center mb-4">
            ...
            <div class="form-outline flex-fill mb-0">
              <input type="email" id="form3Example3c"  placeholder="email"  name="email"class="form-control" />
        ...
        <div class="d-flex flex-row align-items-center mb-4">
            ...
            <div class="form-outline flex-fill mb-0">
              <input list="seats" class="form-control" name="age" placeholder="age" id="formFileMultiple" type="number"> 
